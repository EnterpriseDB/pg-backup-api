...
class Status(Model):
    ...
    def __init__(self, archive_command=None, archive_mode=None, archive_timeout=None, archived_count=None, checkpoint_timeout=None, config_file=None, connection_error=None, current_archived_wals_per_second=None, current_lsn=None, current_size=None, current_xlog=None, data_checksums=None, data_directory=None, failed_count=None, has_backup_privileges=None, hba_file=None, hot_standby=None, ident_file=None, is_archiving=None, is_in_recovery=None, is_superuser=None, last_archived_time=None, last_archived_wal=None, last_failed_time=None, last_failed_wal=None, max_replication_slots=None, max_wal_senders=None, pgespresso_installed=None, postgresql_systemid=None, replication_slot=None, replication_slot_support=None, server_txt_version=None, stats_reset=None, synchronous_standby_names=None, wal_compression=None, wal_keep_size=None, wal_level=None, xlog_segment_size=None):  # noqa: E501
    ...
    def replication_slot(self, replication_slot):
        ...
        if replication_slot is not None and len(replication_slot) > 3:
            raise ValueError("Invalid value for `replication_slot`, number of items must be less than or equal to `3`")  # noqa: E501
        if replication_slot is not None and len(replication_slot) < 3:
            raise ValueError("Invalid value for `replication_slot`, number of items must be greater than or equal to `3`")  # noqa: E501
