...
from pg_backup_api.openapi_server.models.copy_stats_analysis_time_per_item import CopyStatsAnalysisTimePerItem
from pg_backup_api.openapi_server.models.copy_stats_copy_time_per_item import CopyStatsCopyTimePerItem
from pg_backup_api.openapi_server.models.copy_stats_serialized_copy_time_per_item import CopyStatsSerializedCopyTimePerItem
from pg_backup_api.openapi_server import util

from pg_backup_api.openapi_server.models.copy_stats_analysis_time_per_item import CopyStatsAnalysisTimePerItem  # noqa: E501
from pg_backup_api.openapi_server.models.copy_stats_copy_time_per_item import CopyStatsCopyTimePerItem  # noqa: E501
from pg_backup_api.openapi_server.models.copy_stats_serialized_copy_time_per_item import CopyStatsSerializedCopyTimePerItem  # noqa: E501
...
class CopyStats(Model):
    ...
    def __init__(self, analysis_time=None, analysis_time_per_item=None, copy_time=None, copy_time_per_item=None, number_of_workers=None, serialized_copy_time=None, serialized_copy_time_per_item=None, total_time=None):  # noqa: E501
    ...
    def copy_time(self, copy_time):
        ...
        if copy_time is None:
            raise ValueError("Invalid value for `copy_time`, must not be `None`")  # noqa: E501
