...
class Config(Model):
    ...
    def __init__(
        ...
        :param backup_compression: The backup_compression of this Config.  # noqa: E501
        :type backup_compression: str
        :param backup_compression_format: The backup_compression_format of this Config.  # noqa: E501
        :type backup_compression_format: str
        :param backup_compression_level: The backup_compression_level of this Config.  # noqa: E501
        :type backup_compression_level: int
        :param backup_compression_location: The backup_compression_location of this Config.  # noqa: E501
        ...
        :param recovery_staging_path: The recovery_staging_path of this Config.  # noqa: E501
    ...
    def backup_compression(self, backup_compression):
        """Sets the backup_compression of this Config.

        The type of compression to be applied during the backup process (only supported when backup_method = postgres)   # noqa: E501

        :param backup_compression: The backup_compression of this Config.
        :type backup_compression: str
        """
    ...
    def backup_compression_format(self, backup_compression_format):
        """Sets the backup_compression_format of this Config.

        The format for the backup output - this can be either \"plain\" or \"tar\" (only supported when backup_method = postgres)   # noqa: E501

        :param backup_compression_format: The backup_compression_format of this Config.
        :type backup_compression_format: str
        """
    ...
    def backup_compression_level(self, backup_compression_level):
        """Sets the backup_compression_level of this Config.

        The compression level to be applied when compressing the backup (only supported when backup_method = postgres)   # noqa: E501

        :param backup_compression_level: The backup_compression_level of this Config.
        :type backup_compression_level: int
        """
    ...
    def backup_compression_location(self):
        """Gets the backup_compression_location of this Config.
        ...
        :return: The backup_compression_location of this Config.
        :rtype: str
        """
    ...
    def backup_compression_location(self, backup_compression_location):
        """Sets the backup_compression_location of this Config.

        This can be set to either \"server\" or \"client\" depending on where the compression should be performed (only supported when backup_method = postgres)   # noqa: E501

        :param backup_compression_location: The backup_compression_location of this Config.
        :type backup_compression_location: str
        """
    ...
    def recovery_staging_path(self, recovery_staging_path):
        """Sets the recovery_staging_path of this Config.

        Path on the recovery host where compressed backups can be temporarily staged during recovery   # noqa: E501

        :param recovery_staging_path: The recovery_staging_path of this Config.
        :type recovery_staging_path: str
        """
