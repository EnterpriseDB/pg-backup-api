#!/usr/bin/env python3
#  © Copyright EnterpriseDB UK Limited 2020-2021 - All rights reserved.
#
"""
Generate changelogs for deb, rpm and humans from a source yaml file using
Jinja templates.
...
TEMPLATES = [
    ...
    os.path.join(TEMPLATE_DIR, "rpm.changelog.jinja2"),
]
